...
var ImageChooserPopupComponent = /** @class */ (function () {
    ...
    ImageChooserPopupComponent.prototype.getCanonicalUrl = function (url) {
...
var ImagesComponent = /** @class */ (function () {
    ...
    ImagesComponent.prototype.loadImages = function (filter, force) {
        ...
        this.modelService.getImages(filter).subscribe(function (images) {
            images.forEach(function (rawImage, index) {
                var image = _models_cms_image__WEBPACK_IMPORTED_MODULE_2__["CmsImage"].fromRaw(rawImage);
                images[index] = image;
            });
...
var PageEditorTreeComponent = /** @class */ (function () {
    ...
    PageEditorTreeComponent.prototype.isOpen = function (key) {
        var index = this.uniqKey + key;
    ...
    PageEditorTreeComponent.prototype.iniAccordion = function () {
        var accordionState = localStorage.getItem('accordion');
        if (!accordionState) {
...
var PagesComponent = /** @class */ (function (_super) {
    ...
    PagesComponent.prototype.canDeletePage = function () {
        var canNotDelete = Array.apply(null, { length: 47 }).map(Number.call, Number);
